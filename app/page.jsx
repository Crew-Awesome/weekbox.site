  ...
  return (
    <div className="layout-container">
      ...
      <nav className="layout-nav" aria-label="Main navigation">
        <Link href="/" className="layout-nav__link">Home</Link> | <Link href="/downloads" className="layout-nav__link">Downloads</Link> | <a href="https://github.com/Crew-Awesome/Weekbox" target="_blank" rel="noreferrer" className="layout-nav__link">GitHub</a> | <a href="https://discord.gg/xQTtYF2Cfn" target="_blank" rel="noreferrer" className="layout-nav__link">Discord</a> | <button type="button" onClick={toggleLanguage} className="layout-nav__link lang-switcher" aria-label="Switch language">{language}</button>
      </nav>
