    ...
    <div className="layout-container">
      ...
      <div className="layout-content-wrapper">
        <aside className="layout-sidebar">
          <Box title="About Weekbox"><div className="box__content--center"><img src={asset('icon.webp')} alt="Weekbox Icon" width="100" draggable="false" /><p>A Re-Imagined Original FNF Mod Launcher</p><a href="https://fnfweekbox.vercel.app/downloads" className="btn">Download Now</a></div></Box>
