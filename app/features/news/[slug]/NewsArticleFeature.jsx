...
export default function NewsArticleFeature({ post }) {
  ...
  return <div className="layout-content-wrapper news-layout">
    <aside className="layout-sidebar news-article-aside">
      <section className="box"><div className="box__header">{t('news.article')}</div><div className="box__content"><Link href="/features/news" className="news-back">← {t('news.allNews')}</Link></div></section>
    </aside>
      ...
      <section className="box news-article-panel">
        ...
        <div className="box__content">
          <article className="news-article">
            ...
            <div className="news-article__body"><Markdown remarkPlugins={[remarkGfm]}>{post.body}</Markdown></div>
          </article>
        </div>
      </section>
    </div>
